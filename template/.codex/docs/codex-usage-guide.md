...
> **Source files** live at `${CLAUDE_PLUGIN_ROOT}` (resolves at plugin load time; concrete path on this machine: `$HOME/.claude/plugins/cache/openai-codex/codex/1.0.2/`):
>
...
**Code implementation review** (the project components):
```
